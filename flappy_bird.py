...
class Floor:
    ...
    def move(self):
        ...
        :return: None
        """
        self.x1 -= self.movement_rate
        self.x2 -= self.movement_rate
...
def draw_window(win, birds, pipes, floor, score, gen, pipe_ind):
    """
